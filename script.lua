...
function startFarm()
    ...
    farmConnection = RunService.Heartbeat:Connect(function()
        ...
        _G.currentCave = _G.currentCave + 1
        isCaveTeleporting = true
        teleportToCavePart(_G.currentCave)
        task.wait(0.5)
        isCaveTeleporting = false
    end)
end
...
function toggleFarm()
    if _G.autoFarm then stopFarm() else startFarm() end
end
...
UIS.InputBegan:Connect(function(input, gameProcessed)
    ...
    elseif input.KeyCode == Enum.KeyCode.F2 then
        ...
        if _G.espEnabled then enableESP() else disableESP() end
        espToggle.Text = _G.espEnabled and "ON" or "OFF"
        espToggle.BackgroundColor3 = _G.espEnabled and Color3.fromRGB(0, 130, 255) or Color3.fromRGB(50, 50, 80)
    elseif input.KeyCode == Enum.KeyCode.F3 then
        _G.autoFarm = not _G.autoFarm
        if _G.autoFarm then startFarm() else stopFarm() end
        farmToggle.Text = _G.autoFarm and "ON" or "OFF"
        farmToggle.BackgroundColor3 = _G.autoFarm and Color3.fromRGB(0, 130, 255) or Color3.fromRGB(50, 50, 80)
    elseif input.KeyCode == Enum.KeyCode.F4 then
        _G.infiniteJump = not _G.infiniteJump
        jumpToggle.Text = _G.infiniteJump and "ON" or "OFF"
        jumpToggle.BackgroundColor3 = _G.infiniteJump and Color3.fromRGB(0, 130, 255) or Color3.fromRGB(50, 50, 80)
    elseif input.KeyCode == Enum.KeyCode.F5 then
        _G.fullBright = not _G.fullBright
        Lighting.Brightness = _G.fullBright and 2 or 1
        Lighting.Ambient = _G.fullBright and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(127, 127, 127)
        brightToggle.Text = _G.fullBright and "ON" or "OFF"
        brightToggle.BackgroundColor3 = _G.fullBright and Color3.fromRGB(0, 130, 255) or Color3.fromRGB(50, 50, 80)
    elseif input.KeyCode == Enum.KeyCode.F6 then
        _G.noclipEnabled = not _G.noclipEnabled
        if _G.noclipEnabled then enableNoclip() else disableNoclip() end
        noclipToggle.Text = _G.noclipEnabled and "ON" or "OFF"
        noclipToggle.BackgroundColor3 = _G.noclipEnabled and Color3.fromRGB(0, 130, 255) or Color3.fromRGB(50, 50, 80)
    elseif input.KeyCode == Enum.KeyCode.F7 then
        _G.antiAFK = not _G.antiAFK
        if _G.antiAFK then enableAntiAFK() else disableAntiAFK() end
        afkToggle.Text = _G.antiAFK and "ON" or "OFF"
        afkToggle.BackgroundColor3 = _G.antiAFK and Color3.fromRGB(0, 130, 255) or Color3.fromRGB(50, 50, 80)
    elseif input.KeyCode == Enum.KeyCode.F8 then
        _G.autoFlyToCave = not _G.autoFlyToCave
        if _G.autoFlyToCave then
            if Player.Character and not isFlyingToCave then
                startFlyToCave()
            end
        else
        ...
        flyToggle.Text = _G.autoFlyToCave and "ON" or "OFF"
        flyToggle.BackgroundColor3 = _G.autoFlyToCave and Color3.fromRGB(0, 130, 255) or Color3.fromRGB(50, 50, 80)
